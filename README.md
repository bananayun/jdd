...
* 自己在青龙配置里加参数
```
ql repo https://github.com/gys619/jdd.git "jd_|jx_|jddj_|gua_|jddj_|getJDCookie|wskey|ht_" "activity|backUp|scf_test_event" "^jd[^_]|USER|utils|ZooFaker_Necklace|JDJRValidator_Pure|sign_graphics_validate|jddj_cookie|function|sign"
```
```
推荐定时 0 */4 * * *
```
...
* 同步了[Mashiro2000](https://github.com/Mashiro2000/HeyTap)大佬得欢太脚本，可以在青龙变量中添加
* 加了[Mashiro2000](https://github.com/Mashiro2000/HeyTap)大佬的欢太任务,具体详情可去大佬仓库查看
  * 文件说明
    ```text
    │  HeyTap.py         # 欢太商城任务中心
